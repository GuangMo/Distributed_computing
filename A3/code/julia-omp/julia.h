...
int julia(const double *x, int xres, const double *y, int yres, const double *c, int flag, int maxIterations, int *iterations, double * start_times, double * end_times, int * max_iterations, int thread_count);
